...
import { exportTableToCsv, exportMultipleTablesToCsv, generateCsvFilename } from './csv-export';
...
describe('exportTableToCsv', () => {
  ...
  it('should escape cells containing delimiter', () => {
    const rowsWithComma = [{ name: 'field,with,commas', type: 'string', required: true }];
  ...
  it('should escape cells containing quotes', () => {
    const rowsWithQuotes = [{ name: 'field"with"quotes', type: 'string', required: true }];
  ...
  it('should handle null and undefined values', () => {
    const rowsWithNulls = [{ name: 'test', type: null, required: undefined }];
