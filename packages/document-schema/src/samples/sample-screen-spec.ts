      ...
      fields: [
        {
          ...
          table: {
            ...
            defaultRows: [
              ...
              {
                parameterName: '支払い情報',
                parameterKey: 'paymentInfo',
                dataType: 'object',
                required: true,
                description: '決済に必要な支払い情報',
                note: 'cardNumber, expiryDate 等を含む',
              },
            ],
          },
        },
          ...
          table: {
            ...
            defaultRows: [
              ...
              },
              {
                ...
                dataType: 'string',
                description: '注文の状態',
                note: 'confirmed | failed',
              },
              {
                parameterName: '合計金額',
                parameterKey: 'totalAmount',
                dataType: 'number',
                description: '税込み合計金額',
                note: '',
              },
          ...
          table: {
            ...
            defaultRows: [
              ...
              },
              {
                ...
                condition: '決済処理失敗',
                message: '決済に失敗しました。支払い情報を確認してください',
                note: 'リトライ可',
              },
            ],
          },
          ...
          fields: [
            {
              ...
              valueType: 'textarea',
              defaultValue:
                'ユーザーが商品をカートに入れた後、決済画面に遷移し、支払い方法を選択して注文を確定する。',
            },
          ],
        },
        {
                ...
                columns: [
                  {
                    ...
                    valueType: 'reference',
                    description:
                      'Project内のAPI仕様書を選択します。選択肢はProject内のapi-specから自動生成されます。',
                    reference: {
                      id: 'ref-api-document',
                      key: 'api-document',
                      label: 'API仕様書',
